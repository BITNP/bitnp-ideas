...
import type { ProjectRead, ProjectCreate, ProjectUpdate, IdeaRead, ApiMessage } from '@/types/api'

export const projectsApi = {
  list() { return api.get<ProjectRead[]>('/projects') },
  ...
  listIdeas(projectId: string) { return api.get<IdeaRead[]>(`/projects/${projectId}/ideas`) },
  addIdea(projectId: string, ideaId: string) { return api.post<ApiMessage>(`/projects/${projectId}/ideas`, { idea_id: ideaId }) },
