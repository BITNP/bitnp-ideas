...
export const ideasApi = {
  ...
  updateStatus(id: string, data: IdeaStatusUpdate) { return api.post<IdeaRead>(`/ideas/${id}/status`, data) },
  addTag(id: string, tagId: string) { return api.post<ApiMessage>(`/ideas/${id}/tags`, { tag_id: tagId }) },
